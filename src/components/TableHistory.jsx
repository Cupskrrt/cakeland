...
import { MOCK_DATA_TRANSACTION_HISTORY } from "../utils/data";
import { COLUMNS_HISTORY } from "../utils/columns";

export default function TableHistory() {
  const columns = useMemo(() => COLUMNS_HISTORY, []);
  const data = useMemo(() => MOCK_DATA_TRANSACTION_HISTORY, []);
